...
def driver_update():
    ...
    driver_directory = r"D:\Education\IT\Modul_27_selenium\chromedriver"
...
def web_browser(request):
    ...
    # browser.set_window_size(1400, 1000)  # для теста, когда все элементы сдвигаются
    ...
    if request.node.rep_call.failed:
        ...
        try:
            ...
            # # ознакомиться https://habr.com/ru/articles/513432/
